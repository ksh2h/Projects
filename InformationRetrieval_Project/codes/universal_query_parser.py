...
def universal_parser( query ):
    ...
    possibilities["coauth"] = [ 'by (.+?)\'s coauth (&|#)', 'coauth of (.+?) (&|#)' ]
    '''
    ...
    for key in possibilities:
        for possib in possibilities[key]:
            try:
                ...
                continue
    print content
    if "coauth" in content and "venue" in content:
        return [2, content["coauth"], content["venue"] ]
    elif "author" in content and "venue" in content:
